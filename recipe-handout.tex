...
\vspace*{-\baselineskip}
\begin{table}[ht]
	\begin{tabularx}{\textwidth}{>{\hsize=0.05\hsize}X>{\bf\hsize=0.08\hsize}X>{\bf\hsize=1\hsize}X}
	3 & oz & butter \\
...
Some thoughts about this recipe. Remove brownies from refrigerator and allow brownies to cool completely before cutting into 2 in. x 2 in. squares and storing in an airtight container, plastic bag, or cookie jar at room temperature for up to five days.

Some more thoughts about this recipe. Remove brownies from refrigerator and allow brownies to cool completely before cutting into 2 in. x 2 in. squares and storing in an airtight container, plastic bag, or cookie jar at room temperature for up to five days.
